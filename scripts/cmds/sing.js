...
module.exports = {
  config: {
    ...
    countDown: 0,
    role: 0,
    shortDescription: "get music",
    longDescription: "Get music and send music",
    category: "music",
  ...
  onStart: async function ({ api, event, args, message }) {
    ...
    const url = 'https://hiroshi-rest-api.replit.app/search/spotify?search=' + encodeURIComponent(query);
